...
class XiaomiJoystick:
    ...
    def _move_stick(self, x_code, y_code, x_val, y_val, duration: float):
    ...
    def _move_hat(self, axis_code: int, value: int, duration: float):
    ...
    def left_stick(self) -> Stick:
        ...
        return SimpleNamespace(
            up=lambda duration=1.0: self._move_stick(
                self.ABS_X, self.ABS_Y, self.CENTER, self.ABS_MIN, duration
            ),
            down=lambda duration=1.0: self._move_stick(
                self.ABS_X, self.ABS_Y, self.CENTER, self.ABS_MAX, duration
            ),
            left=lambda duration=1.0: self._move_stick(
                self.ABS_X, self.ABS_Y, self.ABS_MIN, self.CENTER, duration
            ),
            right=lambda duration=1.0: self._move_stick(
                self.ABS_X, self.ABS_Y, self.ABS_MAX, self.CENTER, duration
            ),
        )
    ...
    def right_stick(self) -> Stick:
        ...
        return SimpleNamespace(
            up=lambda duration=1.0: self._move_stick(
                self.ABS_Z, self.ABS_RZ, self.CENTER, self.ABS_MIN, duration
            ),
            down=lambda duration=1.0: self._move_stick(
                self.ABS_Z, self.ABS_RZ, self.CENTER, self.ABS_MAX, duration
            ),
            left=lambda duration=1.0: self._move_stick(
                self.ABS_Z, self.ABS_RZ, self.ABS_MIN, self.CENTER, duration
            ),
            right=lambda duration=1.0: self._move_stick(
                self.ABS_Z, self.ABS_RZ, self.ABS_MAX, self.CENTER, duration
            ),
        )
    ...
    def dpad(self) -> DPad:
        """D-pad."""
        return SimpleNamespace(
            up=lambda duration=1.0: self._move_hat(self.ABS_HAT0Y, -1, duration),
            down=lambda duration=1.0: self._move_hat(self.ABS_HAT0Y, 1, duration),
            left=lambda duration=1.0: self._move_hat(self.ABS_HAT0X, -1, duration),
            right=lambda duration=1.0: self._move_hat(self.ABS_HAT0X, 1, duration),
        )

...
class AFKJourneyNavigation(Game, ABC):
    ...
    def navigate_to_default_state(
        ...
        while True:
            if not Game.is_game_running(self):
            ...
            match result.template:
                ...
                case "arcane_labyrinth/select_a_crest.png":
                    Game.tap(self, Point(550, 1460))  # bottom crest
                    sleep(1)
        ...
        while True:
            ...
            try:
                while self._can_see_time_of_day_button():
                    Game.tap(self, self.RESONATING_HALL_POINT, scale=True)
                    sleep(3)
                    click_count += 1
    ...
    def navigate_to_afk_stages_screen(self) -> None:
        ...
        Game.tap(self, Point(x=550, y=1080), scale=True)  # click rewards popup
        sleep(1)

    def _navigate_to_battle_modes_screen(self) -> None:
        Game.tap(self, self.BATTLE_MODES_POINT, scale=True)
    ...
    def navigate_to_duras_trials_screen(self) -> None:
        ...
        def stop_condition() -> bool:
            match = Game.game_find_template_match(
                self,

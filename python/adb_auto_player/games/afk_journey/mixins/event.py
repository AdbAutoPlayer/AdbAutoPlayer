    ...
    def event_monopoly_assist(self) -> NoReturn:
        ...
        while True:
            ...
            while next_assist is None:
                assists = Game.find_all_template_matches(
                    self,
